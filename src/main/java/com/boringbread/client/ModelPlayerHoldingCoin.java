...
public class ModelPlayerHoldingCoin extends ModelBiped {
    ...
    public ModelPlayerHoldingCoin(float modelSize, boolean smallArmsIn)
    {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        this.bipedRightArm.rotateAngleX = -1.5708F;
        this.bipedRightArmwear.rotateAngleX = -1.5708F;
