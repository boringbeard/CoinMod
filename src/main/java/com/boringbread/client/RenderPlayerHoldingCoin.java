...
public class RenderPlayerHoldingCoin extends RenderLivingBase<AbstractClientPlayer>
{
    /** this field is used to indicate the 3-pixel wide arms */
    private final boolean smallArms;

    public RenderPlayerHoldingCoin(RenderManager renderManager, boolean useSmallArms)
    {
        super(renderManager, new ModelPlayerHoldingCoin(0.0F, useSmallArms), 0.5F);
    ...
    public ModelPlayerHoldingCoin getMainModel()
    {
        return (ModelPlayerHoldingCoin)super.getMainModel();
    }
    ...
    {
        ModelPlayerHoldingCoin modelplayer = this.getMainModel();
